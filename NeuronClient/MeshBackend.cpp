...
void MeshBackend::CreatePipeline(ID3D12Device* _device)
{
  ...
  const std::array<D3D12_INPUT_ELEMENT_DESC, 8> inputLayout = {
    ...
    D3D12_INPUT_ELEMENT_DESC{"COLOR", 3, DXGI_FORMAT_R8G8B8A8_UNORM, 0, offsetof(MeshRenderer::MeshVertex, rimColor),
                             D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0},
    D3D12_INPUT_ELEMENT_DESC{"COLOR", 4, DXGI_FORMAT_R8G8B8A8_UNORM, 0, offsetof(MeshRenderer::MeshVertex, glintColor),
                             D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0},
    D3D12_INPUT_ELEMENT_DESC{"COLOR", 5, DXGI_FORMAT_R8G8B8A8_UNORM, 0, offsetof(MeshRenderer::MeshVertex, quarterLitColor),
                             D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0},
  };
