...
| ~~Runtime assets (`resource/`)~~ **Superseded by ADR-004: they are `GameData/`, as real files apart from those it lists.** | The LFS pointer files, as `ltheory-old-main/` has them (D12) | — | — |
