...
**Status:** Deprecated by ADR-015 — `LoopbackTransport` and `MessageQueue` were deleted on 2026-09-10. Read this before re-deciding transport for the 4X: the queue discipline and the reasons for it still apply.
