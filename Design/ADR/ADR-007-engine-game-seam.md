...
**Status:** Deprecated by ADR-015 — `Simulation.h` was deleted on 2026-09-10. The seam it describes was shaped around `MoveToOrder`/`ShipState`; the rule it protects, that the engine knows nothing about this game (R9), is in AGENTS.md and is unaffected.
