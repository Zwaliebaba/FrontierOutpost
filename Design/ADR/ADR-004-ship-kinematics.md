...
**Status:** Deprecated by ADR-015 — `GameLogic/Ship` was deleted on 2026-09-10. The 4X moves fleets along lanes at authored tick costs, so nothing here describes the tree any more.
