...
**Status:** Accepted — **its tone count and its light direction are amended by ADR-104 (2026-09-14)**: a lit surface is one of three authored tones rather than two, and the galaxy's light is raked across the opening framing rather than sitting behind the eye. Everything else here stands. **ADR-105 (2026-09-14) amends it again**: four tones rather than three, and a second world direction that is not a light — it casts the stations' shadows and shades nothing.
