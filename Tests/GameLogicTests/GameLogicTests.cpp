...
// GameLogic build through CI unnoticed. The assertion below is the one thing worth asserting
// before there is any GameLogic code -- that this really is the only platform we build
// (AGENTS.md 3). Delete this class when the first real GameLogic test lands.
