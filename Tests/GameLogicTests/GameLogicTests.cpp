...
// GameLogic has no behaviour left to test.
//
// It held the ship's kinematics and the World that ticked it until 2026-09-11, when ADR-015 removed the MVP-01 vertical slice. What remains
// is the library's umbrella header and its precompiled header -- the shape of a project waiting
// for the 4X simulation that will replace it.
//
